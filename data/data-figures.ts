...
export const DATA_FIGURES: DataFigure[] = [
  ...
  },
  {
    ...
    dataset: "DATASET / 010",
    title: "SIGNAL / NOISE",
    subtitle: "AMBIENT NOISE VS. CONCENTRATION",
    type: "scatter",
    size: "small",
    xLabel: "DB",
    yLabel: "FOCUS",
    observation: "SOME NOISE HELPS. MORE DOESN'T.",
    status: "ILLUSTRATIVE DATA",
    date: "31.08.26",
    source: "HYPOTHETICAL ENVIRONMENT LOG",
    data: [
      { x: 20, y: 5.5 }, { x: 35, y: 7.2 }, { x: 45, y: 8.4 }, { x: 55, y: 7.8 },
      { x: 65, y: 6.0 }, { x: 75, y: 3.9 }, { x: 85, y: 2.1 },
    ],
  },
  {
    id: "mood-curve",
    ...
    dataset: "DATASET / 011",
    title: "MOOD CURVE",
    subtitle: "DAILY MOOD ACROSS ONE WEEK",
    type: "line",
    size: "small",
    xLabel: "DAY",
    yLabel: "MOOD",
    observation: "THE CURVE ISN'T AS SMOOTH AS I'D LIKE.",
    status: "EXPERIMENTAL DATA",
    date: "31.08.26",
    source: "HYPOTHETICAL DAILY LOG",
    data: [
      { x: 0, y: 6 }, { x: 1, y: 5 }, { x: 2, y: 7 }, { x: 3, y: 4 },
      { x: 4, y: 8 }, { x: 5, y: 7 }, { x: 6, y: 9 },
    ],
  },
  {
    id: "keyboard-activity",
    fig: "12",
    dataset: "DATASET / 012",
    title: "KEYBOARD ACTIVITY",
    subtitle: "KEYSTROKES BY HOUR BLOCK",
    type: "bar",
    size: "small",
    xLabel: "HOUR",
    yLabel: "KEYS",
    observation: "THE QUIETEST HOUR IS STILL NOT SILENT.",
    status: "SAMPLE DATA",
    date: "31.08.26",
    source: "HYPOTHETICAL INPUT LOG",
    data: [
      { label: "06", value: 3 }, { label: "10", value: 8 }, { label: "14", value: 6 },
      { label: "18", value: 9 }, { label: "22", value: 4 },
    ],
  },
];
